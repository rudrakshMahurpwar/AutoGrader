...
def grade_answers(reference_answers, student_answers):
    ...
    for student, answers in student_answers.items():
        ...
        for idx, q_id in enumerate(answers):
            ...
            # print("student_embedding: ", student_embedding)
            print("Length of student_embedding: ", len(student_embedding))
            # print("ref_embedding: ", ref_embedding)
            print("Length of ref_embedding: ", len(ref_embedding))
